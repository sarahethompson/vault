...
There is also a companion command-line utility to evaluate cron time expressions: <https://github.com/gorhill/cronexpr/tree/main/cronexpr> (which of course uses this library).
