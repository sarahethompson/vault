# Vault Plugin: AliCloud Auth Backend [![Build Status](https://travis-ci.org/hashicorp/vault-plugin-auth-alicloud.svg?branch=main)](https://travis-ci.org/hashicorp/vault-plugin-auth-alicloud)
