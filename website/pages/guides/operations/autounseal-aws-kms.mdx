...
unsealed. Unsealing is the process of constructing the main key necessary to
...
[hashicorp/vault-guides](https://github.com/hashicorp/vault-guides/tree/main/operations/aws-kms-unseal/terraform-aws)
