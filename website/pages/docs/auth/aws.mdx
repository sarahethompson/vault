...
The account in which Vault is running (i.e. the main account) must be listed as
...
Furthermore, in the main account, Vault must be granted the action `sts:AssumeRole`
