...
to protect all the data. That key is protected by a main key. By default,
...
main key into 5 shares, any 3 of which are required to reconstruct the main
key.
...
Shamir's technique can be disabled, and the main key used directly for
