...
description: |-
  The "operator unseal" allows the user to provide a portion of the main key
  to unseal a Vault server.
---

# operator unseal

The `operator unseal` allows the user to provide a portion of the main key to
unseal a Vault server. Vault starts in a sealed state. It cannot perform
operations until it is unsealed. This command accepts a portion of the main
key (an "unseal key").
