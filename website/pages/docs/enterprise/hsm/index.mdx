...
description: >-
  Vault Enterprise has HSM support, allowing for external main key storage and
  automatic unsealing.
---
...
- Automatic Unsealing: Vault stores its HSM-wrapped main key in storage,
...
- [Entropy Augmentation](/docs/enterprise/entropy-augmentation) to
...
[Behavioral Changes](/docs/enterprise/hsm/behavior) page for
