...
The response conforms to the [OpenAPI V3 specification](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.2.md),
...
The response may include Vault-specific [extensions](https://github.com/oai/openapi-specification/blob/main/versions/3.0.2.md#specification-extensions). Three are currently defined:
