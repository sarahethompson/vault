...
This endpoint is used to enter a single main key share to progress the
unsealing of the Vault. If the threshold number of main key shares is reached,
...
- `key` `(string: "")` – Specifies a single main key share. This is required
